...
<div id="error-alert"
     role="alert"
     class="fixed top-16 right-0 p-2 w-80 opacity-0 hidden">
    <div class="flex p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg">
        <svg
                aria-hidden="true"
        ...
        <div class="w-full">
            <div class="flex items-center justify-between">
                <div id="error-alert-title" class="font-medium">Error!</div>
                <button
                        aria-label="Close"
