export const Route = {
    ADMIN_DASHBOARD_ADD_USER: 'admin-dashboard/add-user',
    ADMIN_DASHBOARD_DELETE_USER: 'admin-dashboard/delete-user',
    ADMIN_DASHBOARD_EDIT_USER: 'admin-dashboard/edit-user',
