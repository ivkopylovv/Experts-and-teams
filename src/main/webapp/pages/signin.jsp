...
<div class="body flex flex-col items-center justify-center">
    <form id="signin" class="w-full max-w-sm mt-8" action="signin" method="post">
        ...
        <div class="mb-4">
            ...
            <c:if test="${controlsInvalid}">
                <p class="error mt-2 text-sm text-red-600">Invalid username or password</p>
            </c:if>
        </div>
        ...
        <button type="submit"
            ...
            <svg aria-hidden="true" class="loader hidden inline mr-1 w-4 h-4 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
